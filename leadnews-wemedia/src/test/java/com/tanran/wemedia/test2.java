...
public class test2 {
    ...
    public void test() {
        ...
        String url = "http://www.toutiao.com/?wid=1653534319510/";

        //文章详情页的前缀(由于今日头条的文章都是在group这个目录下,所以定义了前缀,而且通过请求获取到的html页面)

        String url2="http://www.toutiao.com/article/";
    ...
    @Test
    public void test2(){
        String content = wmNewsService.selectNewById(360)
            .getContent();
